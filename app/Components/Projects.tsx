        ...
        {projects.map((project, index) => (
          ...
          >
            ...
            <div className={`lg:grid lg:grid-cols-2 lg:gap-16`}>
              ...
              <div>
                <Image
                  className={`mt-8 -mb-5 lg:mt-0 lg:mb-0 lg:absolute false lg:h-full xl:-right-1 lg:w-auto lg:max-w-none ${project.mobile && "w-[28%] -right-1 lg:-bottom-10 lg:w-auto lg:max-w-none mx-auto"} `}
                  src={project.image}
